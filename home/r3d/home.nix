 ...
 
{
  ...
  home = {
    ...
    file.".config/niri/config.kdl".text = ''
      ...
      binds {
        ...
        Mod+V       { spawn-sh "cliphist list | fuzzel | cliphist decode | wl-copy"; }
    ...
    pointerCursor = {
      gtk.enable = true;
      name = "Bibata-Modern-Classic-Left";
    ...
    waybar = {
      ...
      settings = {
        mainBar = {
          ...
          modules-right = [ "network" "bluetooth" "clipboard" "backlight/slider" "pulseaudio" "cpu" "memory" "battery" "tray" ];
          ...
          bluetooth = {
            ...
            on-click = "sh -c 'blueman-applet && blueman-manager'";
          };
      ...
      style = ''
        * {
        ...
        window#waybar {
          background-color: rgba(52, 12, 12, 0.9);
          color: #e0e0e0;
          border-radius: 9px;
          padding: 4px 10px;
          margin: 6px;
        ...
        #clock, #bluetooth, #battery, #cpu, #memory, #network, #pulseaudio, #tray {
          padding: 0 10px;
          margin: 0 3px;
        }
  ...
  systemd.user.services = {
    ...
    mako = {
      Unit = {
        Description = "Notification Daemon (Mako)";
        After = [ "graphical-session.target" ];
        Wants = [ "graphical-session.target" ];
      };
      Service = {
